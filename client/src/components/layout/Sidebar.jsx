...
const Sidebar = ({ onClose }) => {
  ...
  return (
    <aside className="flex flex-col h-full bg-white dark:bg-gray-800 border-r border-surface-border w-64">
      {/* logo */}
      ...
      {user && (
        <div className="px-4 py-4 border-t border-surface-border">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-brand-coral/20 rounded-full flex items-center justify-center">
              <span className="text-brand-coral font-semibold text-sm">
